        ...
        <div className="flex-col  mt-11  px-10  border rounded">
          <Accordion open={open === 1}>
            ...
            <AccordionBody className="text-center mt-4 ">
              ...
              to share your plastic footprint, and other plastic facts on social
              media.
            </AccordionBody>
          </Accordion>
          <Accordion open={open === 2}>
            ...
            <AccordionBody className="text-center mt-4">
              ...
              you. When you decline plastic straws or cutlery make sure to do it
              at the time you place your order (not when you receive it). This
              blog post has some more specific suggestions:
              <p
          ...
          <Accordion open={open === 4}>
            ...
            <AccordionBody className="text-center mt-4">
              Purchasing in bulk, avoiding individually-wrapped single servings
              and other excess plastic packaging, asking for a glass or mug
              instead of a disposable cup at a cafe, these are all ways to
              reduce your plastic footprint. Apps such as GoodBye Waste (from
              GreenPeace)
              <span
                className="text-blue-600 hover:text-blue-800 text-center font-light underline "
          ...
          <Accordion open={open === 5}>
            ...
            <AccordionBody className="text-center justify-center">
              ...
              microwave-safe silicone lids and reusable food storage containers.
            </AccordionBody>
          </Accordion>
        </div>
      </div>
