...
const Results = ({ result, setResult }) => {
  ...
  useEffect(() => {
    ...
    if (footprint.footprintResult > 4)
      ...
      setFootprint({
        title: "🛒 Average Consumer",
        plastic: rounder(perCapitaAverage),
        carbon: rounder(perCapitaAverage * co2ePerPlasticKg),
      });
    }
            ...
            <Card className="border-none bg-slate-50 rounded-xl basis-3/5 ">
              <CardBody>
                ...
                <p className="text-xs font-normal leading-5 text-gray-800 md:text-md dark:text-slate-100">
                  Based on your country of residence and lifestyle, we estimate
                  you consume around{" "}
