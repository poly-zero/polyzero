      ...
      <div className="h-screen md:-ml-64 ">
            ...
            <Card>
              <div>
                ...
                <p>
                  {" "}
                  <strong>
                    The below is excerpted from the CIEL report entitled
        ...
        <Card>
          ...
          <p className="text-sm text-gray-500 md:text-base">
            ...
            emissions from the Shell plant alone would more or less wipe out all
            the reductions in carbon dioxide that Pittsburgh, just 25 miles
            away, is planning to achieve by 2030. Drilling for natural gas leaks
            methane, a potent climate pollutant; and oil consumption for
            petrochemicals and plastics may account for half the global growth
            in petroleum demand between now and 2050.”
          </p>
          <p className="text-sm text-gray-500 md:text-base">
            ...
            <br />
            “A small number of institutional asset managers and global banks are
            providing billions of dollars to companies that produce polymers
            from fossil fuels, and only a fraction to companies trying to shift
            to a circular plastic economy. This asymmetry urgently needs to be
            reversed.”
          </p>
          <p>
        ...
        <Card className="gap-3">
          ...
          <p className="text-sm text-gray-500 md:text-base">
            A new study finds on average people could be ingesting approximately
            5 grams of plastic every week, which is the equivalent weight of a
            credit card. The analysis No Plastic in Nature: Assessing Plastic
            Ingestion from Nature to People prepared by Dalberg, based on a
            study commissioned by WWF and carried out by University of
          ...
          <p className="text-sm text-gray-500 md:text-base">
            ...
            chemical additives that leach from plastics and reproductive health
            issues, brain health, obesity, diabetes and some types of cancer.
            The effects are evident in babies, children, and adults – young and
            old. Microplastics – tiny particles of plastic under 5mm in length –
            are known to be in our air, soil, rivers, oceans, plants and
            animals. They are from degraded plastic products, textiles, tyre
            abrasion, industry, agriculture and general waste. Microplastics are
            also intentionally added to products, for example cosmetics. We know
            that microplastics get into our gut and lungs, but we don’t yet know
            how far they penetrate our blood and organs nor what impacts they
            have on human health. Concerningly, neither do we know how far the
            smaller virus-sized nanoparticles penetrate our bodies because we do
            not have suitable techniques to measure them. What we do know is
            that plastic is devastating our oceans, freshwater and land
            ecosystems that are essential for all life.
          </p>
        </Card>
        <br />
        <Card>
          ...
          <p>
            <strong>
              Plastic Atlas Asia: Facts and figures about the world of synthetic
              polymers 2021
            </strong>
            <a
              className="font-light text-center text-blue-600 underline hover:text-blue-800 "
